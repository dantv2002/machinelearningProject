...
svc = joblib.load('./src/NhanDangKhuonMat/svc.pkl')
...
if __name__ == '__main__':
    detector = cv.FaceDetectorYN.create(
        './src/NhanDangKhuonMat/face_detection_yunet_2022mar.onnx',
        "",
        (320, 320),
        0.9,
        0.3,
    ...
    recognizer = cv.FaceRecognizerSF.create(
        './src/NhanDangKhuonMat/face_recognition_sface_2021dec.onnx', "")
