...
st.set_page_config(
    page_title="Dự báo giá nhà ở California",
    page_icon="🏠"
)
...
forest_reg = joblib.load("./src/DuBaoGiaNhaCalifornia/forest_reg_model.pkl")
...
x_test = pd.read_csv('./src/DuBaoGiaNhaCalifornia/x_test.csv', header = None, names=column_names)
y_test = pd.read_csv('./src/DuBaoGiaNhaCalifornia/y_test.csv', header = None)
